...
import cn.bo.project.system.entity.SysPost;
import cn.bo.project.system.mapper.SysPostMapper;
import cn.bo.project.system.mapper.SysUserPostMapper;
import cn.bo.project.system.service.SysPostService;
...
public class SysPostServiceImpl extends ServiceImpl<SysPostMapper, SysPost> implements SysPostService {
    ...
    public int deletePostByIds(Long[] postIds)
    {
        for (Long postId : postIds)
        {
            ...
            {
                throw new BootProjectException(String.format("%1$s已分配,不能删除", post.getPostName()));
            }
        }
