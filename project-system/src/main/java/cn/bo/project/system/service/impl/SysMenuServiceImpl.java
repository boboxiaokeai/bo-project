...
import cn.bo.project.system.mapper.SysMenuMapper;
import cn.bo.project.system.mapper.SysRoleMenuMapper;
import cn.bo.project.system.model.MetaModel;
import cn.bo.project.system.model.RouterModel;
import cn.bo.project.system.model.TreeSelect;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
     ...
     */
    @Override
    public List<RouterModel> buildMenus(List<SysMenu> menus) {
        List<RouterModel> routers = new LinkedList<RouterModel>();
    ...
    {
        Long menuId = StringUtils.isEmpty(menu.getMenuId()) ? -1L : menu.getMenuId();
        SysMenu info = menuMapper.checkMenuNameUnique(menu.getMenuName(), menu.getParentId());
        if (StringUtils.isNotEmpty(info) && info.getMenuId().longValue() != menuId.longValue())
        {
